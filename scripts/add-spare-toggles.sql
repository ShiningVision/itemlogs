...
ALTER TABLE settings ADD COLUMN IF NOT EXISTS spare_text_1 VARCHAR(255);
ALTER TABLE settings ADD COLUMN IF NOT EXISTS spare_text_2 VARCHAR(255);
ALTER TABLE settings ADD COLUMN IF NOT EXISTS spare_text_3 VARCHAR(255);
